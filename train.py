...
if __name__ == '__main__':
    ...
    argument_parser.add_argument("--learning_rate", "--lr", type=float, default=1e-3, help="Init learning rate")
    argument_parser.add_argument("--weight_decay", type=float, default=1e-5, help="Set 0 to disable weight decay")
    argument_parser.add_argument("--model_path", type=str, default="./models", help="Path to save models")
    argument_parser.add_argument("--log_path", type=str, default="./train_log", help="Path to save logs")
    argument_parser.add_argument("--epoch", type=int, default=6, help="Epoch")
    argument_parser.add_argument("--images", type=str, default="./data/train", help="Path of tfrecords")
    argument_parser.add_argument("--batch_size", type=int, default=128, help="Batch size")
    argument_parser.add_argument("--keep_prob", type=float, default=0.8, help="Used by dropout")
    ...
    run_training(image_path, batch_size, epoch, model_path, log_dir, start_lr, wd, kp)
